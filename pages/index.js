  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col justify-center items-center text-center px-4">
      ...
      <div className="relative z-10">
        <h1 className={`text-5xl md:text-7xl font-extrabold mb-4 animate-pulse-slow ${audiowide.className}`}>
          smile.bot
        </h1>

        <p className={`text-xl md:text-2xl max-w-xl mx-auto ${syne.className}`}>
